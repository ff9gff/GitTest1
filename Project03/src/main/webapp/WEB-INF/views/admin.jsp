...
<body>
	...
	<div Class="wrapper">
		...
		<nav id ="menuBar">
			...
			<li Class="menuItem">
				<a Class="mylink" href="MyUserInfo.jsp">홈(아직)</a>
				</li>
 ...
 <input type="submit" value="저장" id="saveMyUser" >
 </div>
		    
		</section>
		
		<aside id="sidebar">
		<img alt="고양이" src="images/css_cat.jpg"
				style="width: 170px"/>
		<img alt="강아지" src="images/css_dog.jpg"
				style="width: 170px"/>
		<img alt="백조" src="images/css_swan.jpg"
				style="width: 170px"/>
		</aside>
